...
$sql=mysqli_query($con,"select UID from traveluser where UserName='$email'");
$row=mysqli_num_rows($sql);
if($row>0)
{
    echo "<script>alert('Email id already exist with another account. Please try with other email id');</script>";
} else{
    $msg=mysqli_query($con,"insert into traveluser(UserName,pass) values('$email','$password')");
    $msg=mysqli_query($con,"insert into traveluserdetails(FirstName,LastName,Phone) values('$fname','$lname','$contact')");
                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="mt-4 mb-0">
                                                <div class="d-grid"><button style="background-color: #f33f3f;" type="submit" class="btn btn-primary btn-block" name="submit">Create Account</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                                    <div class="card-footer text-center py-3">
                                        <div class="small">
                                            <a style="color: #f33f3f;" href="login.php">Have an account? Go to login</a>
                                        </div>
                                        <div class="small">
                                            <a style="color: #f33f3f;" href="../index.php">Back to Home</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
