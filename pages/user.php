...
<?php 
$userid=$_GET['UID'];
$query=mysqli_query($con,"select * from traveluserdetails where UID='$userid'");
$POST=mysqli_query($con,"select * from travelpost where UID='$userid'");
$countq=mysqli_query($con,"select count(UIDFollowing) as count from traveluserfollowing where UID='$userid'");
$count=mysqli_fetch_assoc($countq);
while($result=mysqli_fetch_array($query))
{?>
                        <h1 class="mt-4"><?php echo $result['FirstName'];?>'s Profile</h1>
                        <h3 class="mt-4">User Following <?php echo ''.$count['count']?></h3>
                        <div class="card mb-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-bordered">
                                   ...
                                   <tr>
                                       <th>Post Time</th>
                                       <td colspan="3"><?php echo $result['PostTime'];?></td>
                                   </tr>
