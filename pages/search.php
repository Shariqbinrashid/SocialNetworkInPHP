...
<?php include_once($_SERVER['DOCUMENT_ROOT'].'/TravelWebsite/config/config.php'); 

$val = $_GET['search'];

$ret= mysqli_query($con,"SELECT * FROM travelimagedetails where Title like '%$val%' or Description like '%$val%'");
